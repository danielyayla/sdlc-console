...
export function seedFiles(): Record<string, string> {
  ...
  // ---------------- CHG-0012 · Maintain (merged, incident recorded, gate 6 open) ----------------
  {
    ...
    put(`${dir}/pr.yaml`, stringifyYaml({ schema: 1, provider: "local", branch: `${id}/pdf`, baseBranch: "main", headSha: "b1f3c9a2d7e6f5a4b3c2d1e0f9a8b7c6d5e4f3a2", openedAt: T("08-22", "14:10"), mergedAt: T("08-23", "09:00"), mergeSha: "c2e4d0b3e8f7a6b5c4d3e2f1a0b9c8d7e6f5a4b3", reviewers: [ENG], review: { session: "s-0012-review", headSha: "b1f3c9a2d7e6f5a4b3c2d1e0f9a8b7c6d5e4f3a2", at: T("08-22", "16:00") }, findings: { high: 0, medium: 1, low: 2 }, checks: [{ name: "evidence", verdict: "pass" }], planMatches: true }));
