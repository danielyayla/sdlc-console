/**
 * SHA-256 (FIPS 180-4) over a UTF-8 string, written out here because core
 * has no I/O and no Node builtins: the export's content hash must be
 * computable wherever the export is derived. Verified against `node:crypto`
 * in the tests.
 */
